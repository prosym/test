...
い場合は幹事にご相談ください．）
  ...
  <li> <font color=#0000ff>申込み内容の改訂の際にはブラウザの「戻る」機能はお使いにならず，最初から書き直されるようにお願いいたします．</font>
  <li> <font color=#0000ff>申込み内容の改訂をされる際に，ブラウザやプロキシのキャッシュが障害になることがあります．その場合はブラウザのキャッシュをパージする操作や設定を行うか，あるいはプロキシを使わない設定にしてください．（「Proxy error」の無限ループに陥った場合は，ブラウザを再起動すると抜け出せます．）</font>
  <li> 「※」は必須項目を表します．
</ul>
EOM;
