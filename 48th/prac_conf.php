...
//config ---------------------------------------------------
$script    ='prac_ps.php';  /* 実行ファイル名 */
$LogFile   ='../../hidden/48/prac_ps.log';  /* ログ保存ファイル名 セキュリティ注意 */
...
$Stay1='1名1室';
$Stay1cost='(会員 65,000  非会員 70,000)';
$Stay2='2名1室';
$Stay2cost='(会員 45,000  非会員 50,000)';
$Stay3='3名1室';
$Stay3cost='(会員 38,000  非会員 43,000)';
$Stay4='4名1室';
$Stay4cost='(会員 ---  非会員 ---)';
...
<ul>
  ...
  <li> 開催期間中の中途での出入りや，人員の交替はご遠慮ください．
  <li> 参加費には予稿集代，宿泊費，食費，消費税を含みます．宿泊なしの参加は認めません．
  <li> 参加申込者には，請求書，参加章引換券，振替用紙を郵送します．振替用紙を使って郵便局で払い込む場合は，手数料は無料です．
  <li> 今回から，会場では参加費を受け取らないことにしました．お手数ですが，郵便振替，銀行振込み，現金書留などの手段で，事前に参加費の払込みを済ませるようお願いします．

  <li> プログラムは <a href=program48.html>ここ</a>にあります．
</ul>
EOM;
