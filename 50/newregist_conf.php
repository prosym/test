...
$LogFile   ='/var/www/prosym/hidden/50/newregist.log';  /* ログ保存ファイル名 セキュリティ注意 */
//$LogFile   ='/home/shnsk/web_test/newregist.log';  /* ログ保存ファイル名 セキュリティ注意 */
...
$mheader = "第50回プログラミングシンポジウムへの登録を\n以下の通りに受け付けました．\n\nバグ祓いまつりへの申込みもお待ちしております．\n";
...
<title>プログラミング・シンポジウム 参加申込み</title>
</head><body>
EOM;
...
<ul>
  ...
  <li> <font color=#ff0000>振込み締切日：12月19日（金）</font>
  <li> 部屋割りは学会におまかせください．
  ...
  <li> 参加される方（特に学生）で非会員の方は，この機会に入会されることをお勧めします．学生会員の年会費は 4,800円です．詳しくは <a href="http://www.ipsj.or.jp/06mem/nyukai/nyukai.html"> http://www.ipsj.or.jp/06mem/nyukai/nyukai.html</a>を参照ください．
...
い場合は幹事にご相談ください．）
  <li> プログラムは <a href="50program.html">ここ</a>にあります．
